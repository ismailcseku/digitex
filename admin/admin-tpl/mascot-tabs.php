...
<?php
$links = array(
	'mascot-about'			  	=> esc_html__( 'About', 'digitex' ),
	'mascot-docs' 				=> esc_html__( 'Support & Help', 'digitex' ),
	'mascot-faq' 				=> esc_html__( 'FAQ', 'digitex' ),
	'mascot-system-status'     	=> esc_html__( 'System Status', 'digitex' ),
);

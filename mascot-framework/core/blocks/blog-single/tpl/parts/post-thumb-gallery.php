<?php digitex_enqueue_script_lightgallery(); ?>
<?php digitex_enqueue_script_owl_carousel(); ?>
<?php $gallery_images = digitex_get_rwmb_group_advanced( 'digitex_' . "blog_mb_pf_gallery_settings",  "gallery_images", null, false, 'all', 'large' );?>

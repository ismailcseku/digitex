	...
	<?php
	/**
	* digitex_before_footer hook.
	*
	*/
	do_action( 'digitex_before_footer' );
	?>
	<footer id="footer" class="footer <?php echo esc_attr( $footer_classes );?>">
	<?php
		/**
		* digitex_footer_start hook.
		*
		*/
		do_action( 'digitex_footer_start' );
	?>
		<div class="footer-widget-area">
			<?php if ( isset($footer_widget_area) && !empty($footer_widget_area) && mascot_core_digitex_plugin_installed() ) { ?>
	...
	<?php
		/**
		* digitex_footer_end hook.
		*
		*/
		do_action( 'digitex_footer_end' );
	?>
	</footer>
	<?php
	/**
	* digitex_after_footer hook.
	*
	*/
	do_action( 'digitex_after_footer' );
	?>
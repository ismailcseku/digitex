 ...
 */
require_once DIGITEX_FRAMEWORK_DIR . '/tgm/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'digitex_register_required_plugins' );
 ...
 */
function digitex_register_required_plugins() {
	$plugins_path = DIGITEX_FRAMEWORK_DIR . '/tgm/plugins';
	...
	$plugins = array(
		array(
			'name'         	=> 'Mascot Core - Digitex',
			'slug'         	=> 'mascot-core-digitex',
			'source'       	=> $server_path . 'mascot-core-elementor/mascot-core-digitex.zip',
			'required'     	=> true,
			'version'      	=> '1.0'
		),
		array(
	 ...
	 */
	$config = array(
		'id'           => 'digitex',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'message'      => '<div class="notice notice-info is-dismissible mt-20">
			...
			<p><strong>Note from Author ' . DIGITEX_AUTHOR . ':</strong> To ensure the latest version of <em>theme required</em> plugins, you must have the latest version of <strong>' . $theme_name . '</strong></p>
